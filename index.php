        ...
        <div class="row row-cols-1 m-md-2 justify-content-center">
            ...
            <div class="col mt-md-1 mx-md-2" id="display_div">
                ...
                <div class="table-responsive-xl">
                    ...
                    <table class="table bg-opacity-50 bg-dark table-success table-hover text-center table-bordered border-warning" id="all_dept_table">
                        ...
                        <tbody class="table-group-divider" id="all_details_tbody">
                            ...
                            require("resources/php_functions/read_record.php");
                            foreach ($rows as $row) {
                            ...
                            ?>
                                ...
                                <tr>
                                    <td class="col-xl-2">
                                        ...
                                        <input type="text" class="edit_input form-control" hidden name="dept_id" id=" <?php echo $row["dept_id"]; ?>">
                                    </td>
                                    <td class="col-xl-4">
                                        ...
                                        <input type="text" class="edit_input form-control" hidden name="dept_name" id=" <?php echo $row["dept_id"]; ?>">
                                    </td>
                                    <td class="col-xl-4">
                                        ...
                                        <input type="text" class="edit_input form-control" hidden name="dept_manager" id=" <?php echo $row["dept_id"]; ?>">
                                    </td>

                                    <td class="col-xl-2">
                                        <!-- === Delete Button === -->
                                        <button type="button" class="btn btn-close delete_btn" value="<?php echo $row["dept_id"]; ?>"></button>
                                    </td>
                                </tr>
            ...
            <div class="col m-md-0 mx-md-2">
                ...
                <div class="table-responsive-xl">
                    ...
                    <table class="table bg-opacity-50 bg-dark table-hover text-center table-bordered border-warning" id="insertion_table">
                        <caption>
                        ...
                        <tbody class="table-group-divider">
                            <tr>
                                <form id="creation_form" method="post">
                                    ...
                                    <td> <input type="text" class="form-control" name="dept_id" maxlength="3"></td>
                                    <td><input type="text" class="form-control" name="dept_name" maxlength="30"></td>
                                    <td><input type="text" class="form-control" name="dept_manager" maxlength="30"></td>
                                    <td>
                                        <!-- === Create Department Button === -->
                                        <button type="submit" class="btn btn-success" id="sad">Create
                                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" id="creation_spinner" hidden="true"></span>
                                        </button>
